...
use think\Validate;
use cmf\controller\SmsController;
...
class MobileController extends AdminBaseController
{
    ...
    {
        $emailSetting = cmf_get_option('mobile_setting');
    ...
    public function indexPost()
    {
        ...
        if (in_array('', $post) && !empty($post['sms_name'])) {
            $this->error("不能留空！");
        }

        cmf_set_option('mobile_setting', $post);
    ...
    public function test()
    {
        if ($this->request->isPost()) {
            ...
            $result = cmf_send_sms($data['mobile'],$data['content']);
