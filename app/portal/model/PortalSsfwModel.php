...
class PortalSsfwModel extends Model
{
...
//        }
        ...
        foreach ($categories as $item) {
            ...
            $item['str_action'] = '<a href="' . url("AdminSsfw/add", ["parent" => $item['id']]) . '">添加子分类</a>  <a href="' . url("AdminSsfw/edit", ["id" => $item['id']]) . '">' . lang('EDIT') . '</a>  <a class="js-ajax-delete" href="' . url("AdminSsfw/delete", ["id" => $item['id']]) . '">' . lang('DELETE') . '</a> ';
            array_push($newCategories, $item);
        }
