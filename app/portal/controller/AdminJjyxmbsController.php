...
use app\portal\model\PortalJjyxqksyModel;
 ...
 */
class AdminJjyxmbsController extends AdminBaseController
{
    /**
     * 文章标签管理
     * @adminMenu(
    ...
    {
        $portalTagModel = new PortalJjyxqksyModel();
    ...
    public function edit()
    {
        ...
        $portalPostModel = new PortalJjyxqksyModel();
