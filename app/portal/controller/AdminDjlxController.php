...
use app\portal\model\PortalDjlxModel;
use think\Db;
use app\admin\model\ThemeModel;


class AdminDjlxController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    {
        $portalCategoryModel = new PortalDjlxModel();
    ...
    public function addPost()
    {
        ...
        $this->success('添加成功!', url('AdminDjlx/index'));
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            $category = PortalDjlxModel::get($id)->toArray();
