...
class AdminQyjsController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    {
        $portalCategoryModel = new PortalQyjsModel();
    ...
    public function addPost()
    {
        ...
        $this->success('添加成功!', url('AdminQyjs/index'));
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            $category = PortalQyjsModel::get($id)->toArray();
