...
use app\portal\model\PortalXlModel;
use think\Db;
use app\admin\model\ThemeModel;


class AdminXlController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    {
        $portalCategoryModel = new PortalXlModel();
    ...
    public function addPost()
    {
        ...
        $this->success('添加成功!', url('AdminXl/index'));
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            $category = PortalXlModel::get($id)->toArray();
