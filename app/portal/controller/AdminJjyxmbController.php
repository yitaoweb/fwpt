...
use app\portal\model\PortalJjyxqkmbModel;
 ...
 */
class AdminJjyxmbController extends AdminBaseController
{
    /**
     * 文章标签管理
     * @adminMenu(
    ...
    {
        $portalTagModel = new PortalJjyxqkmbModel();
         $portalXzqyModel = new PortalXzqyModel();
        $xzqyTree = $portalXzqyModel->adminCategoryTree();
        $users = Db::name('user')->where('user_type',5)->select();
    ...
    public function edit()
    {
        ...
        $portalPostModel = new PortalJjyxqkmbModel();
        $portalSsfwModel = new PortalSsfwModel();
