...
use app\portal\model\PortalHuafenlxModel;
use think\Db;
use app\admin\model\ThemeModel;


class AdminHuafenlxController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    {
        $portalCategoryModel = new PortalHuafenlxModel();
    ...
    public function addPost()
    {
        ...
        $this->success('添加成功!', url('AdminHuafenlx/index'));
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            $category = PortalHuafenlxModel::get($id)->toArray();
